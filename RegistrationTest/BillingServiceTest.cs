    ...
    public class BillingServiceTest
    {
        ...
        public void ReturnPriceOfSingleRoom()
        {
           ...
           _mealMoq.Setup(x => x.CalculateMealPrice(fullStayPeriod)).Returns(Price.ValueOf(0));
            ...
            var participant=new Participant(RoomChoice.Single,fullStayPeriod, new Email("test@lacombe.fr"), diet);
        ...
        public void ReturnPriceOfDoubleRoom()
        {
            ...
            var participant = new Participant(RoomChoice.Double, fullStayPeriod, new Email("test@lacombe.fr"), diet);
        ...
        public void ReturnPriceOfTripleRoom()
        {
            ...
            var participant = new Participant(RoomChoice.Triple, fullStayPeriod, new Email("test@lacombe.fr"), diet);
        ...
        public void ReturnPriceOfSingleRoomWithMeals()
        {
            ...
            Participant participant=new Participant(RoomChoice.Single, fullStayPeriod, new Email("test@lacombe.fr"), diet);
