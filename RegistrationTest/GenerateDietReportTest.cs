...
namespace CalculateRegistrationTest
{
    ...
    public class GenerateDietReportTest
    {
        ...
        public void Given_one_vegan_participant_for_full_conference_should_return_full_diet_report_with_one_vegan_on_each_meal()
        {
            ...
            {
                new Serving(new Meal(new DateTime(2019, 10, 24), MealType.Dinner), coversResult),
                ...
                new Serving(new Meal(new DateTime(2019, 10, 27), MealType.Lunch), coversResult)
            };
            covers.Setup(x => x.GetCoversByDiet(It.IsAny<Meal>())).
                Returns<Meal>(meal=>new Serving(meal,coversResult));
            ...
            covers.Verify(x => x.GetCoversByDiet(It.IsAny<Meal>()));
        }
